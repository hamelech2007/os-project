...
$(kernel_object_files): build/kernel/%.o : src/impl/kernel/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -g -I src/intf $(intf_c_headers_files_include_flag) -ffreestanding $(patsubst build/kernel/%.o, src/impl/kernel/%.c, $@) -o $@

$(kernel32_asm_files): build/kernel/%.asm : src/impl/kernel/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -g -m32 -S -I src/intf $(intf_c_headers_files_include_flag) -ffreestanding $(patsubst build/kernel/%.asm, src/impl/kernel/%.c, $@) -o $@ && \
	sed -i '1i .code32' $@
...
$(x86_64_c_object_files): build/x86_64/%.o : src/impl/x86_64/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -g -I src/intf $(intf_c_headers_files_include_flag) -ffreestanding $(patsubst build/x86_64/%.o, src/impl/x86_64/%.c, $@) -o $@
...
build-x86_64: $(kernel_object_files) $(x86_64_object_files) $(kernel32_object_files)
	mkdir -p dist/x86_64 && \
	x86_64-elf-ld -n -o dist/x86_64/kernel.bin -T targets/x86_64/linker.ld $(kernel_object_files) $(x86_64_object_files) $(kernel32_object_files) && \
